  ...
  return (
    <>
      <div className="SearchOptions-ViewChange">
        <div
          className="SearchResult-Count-Filters-ViewChange"
        ...
        >
          ...
          >
            <div className="SearchResult-count" style={{ marginRight: "15px" }}>
              <span style={{ color: "blue" }}>{"900"}</span> results
            </div>
            <div
              style={{
                display: "flex",
          ...
          {showFilters && (
            <div
              className="search-filters-container-ViewChange"
              style={{ left: "0", width: "-webkit-fill-available" }}
            >
              ...
              <div className="filters-content-ViewChange" style={{height:"300px",overflowY:"auto"}}>
                          ...
                          {showPlos && (
                            ...
                            <label>
                              <input
                                type="checkbox"
                                value="nutrition"
                                checked={filters.subjectArea?.includes("nutrition")}
                                onChange={handleSubjectAreaFilter}
                              />{" "}
                              Nutrition
                            </label>
                            <label>
                              <input
                                type="checkbox"
                                value="physiology"
                                checked={filters.subjectArea?.includes("physiology")}
                                onChange={handleSubjectAreaFilter}
                              />{" "}
                              Physiology
                            </label>
                            <label>
                              <input
                                type="checkbox"
                                value="biochemistry"
                                checked={filters.subjectArea?.includes("biochemistry")}
                                onChange={handleSubjectAreaFilter}
                              />{" "}
                              Biochemistry
                            </label>
                            <label>
                              <input
                                type="checkbox"
                                value="anatomy"
                                checked={filters.subjectArea?.includes("anatomy")}
                                onChange={handleSubjectAreaFilter}
                              />{" "}
                              Anatomy
                            </label>
                ...
                <div className="filter-group-ViewChange">
                  <h4>Article Type</h4>
                  <div className="subFilters" style={{ marginLeft: "0",display: "flex",
                      flexDirection: "row",
                      gap: "5%", }}>
                    {showArticleType && (
                      <>
                          ...
                          {showBiorxivType && (
                            ...
                            <label>
                              <input
                                ...
                                checked={filters.articleType?.includes("research article")}
                            ...
                            <label>
                              <input
                                type="checkbox"
                                value="correction"
                                checked={filters.articleType?.includes("correction")}
                                onChange={handleArticleTypeFilter}
                              />{" "}
                              Correction
                            </label>
                            <label>
                              <input
                                ...
                                checked={filters.articleType?.includes("study protocol")}
                                onChange={handleArticleTypeFilter}
                              />{" "}
                              Study Protocol
                            </label>
                            <label>
                              <input
                                type="checkbox"
                                value="lab protocol"
                                checked={filters.articleType?.includes("lab protocol")}
                                onChange={handleArticleTypeFilter}
                              />{" "}
                              Lab Protocol
                            </label>
                  ...
                  {["1", "5", "custom"].map((range) => (
                    <label key={range}>
                      <input
                        ...
                        onChange={() => handleDateFilter(range)}
                      />{" "}
                      {range === "1"
                        ? "1 year"
                        : range === "5"
