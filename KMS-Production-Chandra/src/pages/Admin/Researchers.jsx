...
const Researchers = () => {
    ...
    const fetchUsers = async () => {
      ...
      try {
        const response = await axios.get(
          `https://lfaxil11nf.execute-api.ap-south-1.amazonaws.com/source/admin?user_id=${adminId}&organization_name=${organizationName}`,
          {
            headers: {
  ...
  const handleSuspendClick = async (userId, currentStatus) => {
    ...
    try {
      const response = await axios.put(
        `https://lfaxil11nf.execute-api.ap-south-1.amazonaws.com/source/admin?user_id=${userId}&admin_id=${adminId}&status=${newStatus}`,
        // {
        //   admin_id: adminId,
        //   user_id: userId,
        //   status: newStatus,
  ...
  const handleDeleteClick = async (userId) => {
    try {
      await axios.delete(`https://lfaxil11nf.execute-api.ap-south-1.amazonaws.com/source/admin?user_id=${userId}&admin_id=${adminId}`,
        {
          headers: {
            //Authorization: `Bearer ${token}`,
            "Content-Type": "application/json",
