...
const EditResearcher = () => {
  ...
  //const organizationName = user_id?.organization_name;
  ...
  useEffect(() => {
    const fetchUserDetails = async () => {
      try {
        const response = await axios.get(`https://lfaxil11nf.execute-api.ap-south-1.amazonaws.com/source/user?user_id=${user_id}`, {
          headers: {
    ...
    e.preventDefault();
      try {
        ...
        const response = await axios.put(
          `https://lfaxil11nf.execute-api.ap-south-1.amazonaws.com/source/edit?admin_id=${adminId}&user_id=${user_id}`,
          requestBody,
          {
            headers: {
              //Authorization: `Bearer ${token}`,
