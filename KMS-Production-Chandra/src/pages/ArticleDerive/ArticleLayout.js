...
const ArticleLayout = () => {
  ...
  const handleAnnotateClick = async () => {
    ...
    try {
      ...
      const plainText = fullTextData.body
        .filter((item) =>
          [
            "title",
            "heading",
      ...
      const response = await apiService.annotateArticle(requestBody);
      const data = response.data;
        ...
        <div className={`content ${isMobile ? "mobile-view" : ""}`}>
          ...
          {deriveInsights ? (
            ...
            <ArticleContent
              ...
              setFullTextData={setFullTextData}
            />
          )}
          <div
          ...
          >
            ...
            >
              ...
              {openNotes && (
                <div ref={notesRef} className="notes-height">
                  <Notes
            ...
            <div className="icons-group">
              ...
              {/* <div className="full-text">
                <button onClick={handleFullText} title="View full text">
                  Full Text
                </button>
              </div> */}
              {deriveInsights ? (
