...
// import FullText from "./pages/ArticleDerive/FullText";
import FullTextViewer from "./pages/ArticleDerive/FullTextViewer";
    ...
    <div className="App">
      ...
      <Routes>
        ...
        <Route
          path="/search"
          element={
            location.state ? <SearchResults /> : <Navigate to="/" replace />
          }
        />
        <Route path="/server-error" element={<Error500 />} />
        <Route path="/fulltext" element={<FullTextViewer />} />
